...
def get_ai_4_cut_prompt(frame_color='black', layout='1x4', color_mode='color', style='default'):
    ...
    style_instructions = {
        ...
        'ghibli': "IMPORTANT STYLE: Transform the person into STUDIO GHIBLI style artwork like Spirited Away, My Neighbor Totoro, Howl's Moving Castle, Princess Mononoke, Kiki's Delivery Service. Apply the distinctive Ghibli aesthetic with soft watercolor-like textures, gentle pastel colors, dreamy atmosphere, round soft facial features, and the hand-drawn warmth characteristic of Hayao Miyazaki films."
    }
