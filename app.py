...
def get_ai_4_cut_prompt(frame_color='black', layout='1x4', color_mode='color', style='default'):
    ...
    style_instructions = {
        ...
        'ghibli': "IMPORTANT STYLE: Transform into STUDIO GHIBLI anime style by Hayao Miyazaki. Must look like a character from Spirited Away, My Neighbor Totoro, Howl's Moving Castle, Princess Mononoke, Ponyo, Kiki's Delivery Service, Castle in the Sky."
    }
