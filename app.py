...
def get_ai_4_cut_prompt(frame_color='black', layout='1x4', color_mode='color', style='default'):
    ...
    style_instructions = {
        ...
        'ghibli': "IMPORTANT STYLE: Transform into STUDIO GHIBLI anime style by Hayao Miyazaki. Must look like a character from Spirited Away, Howl's Moving Castle, or Ponyo. Key features: simple round face, small nose, large expressive oval eyes with detailed reflections, thin eyebrows, soft rosy cheeks, flowing hair with individual strands. Use Ghibli's signature hand-painted 2D animation look with visible brush strokes, watercolor backgrounds, warm lighting, and whimsical atmosphere."
    }
